...
#    define KC_EE _CTL_T(KC_E)
#    define KC_FF _ALT_T(KC_F)
#    define KC_NN _ALT_T(KC_N)

#    define KC_JJ _ALT_T(KC_J)
#    define KC_RR _ALT_T(KC_R)
#    define KC_KK _CTL_T(KC_K)
#    define KC_TT _CTL_T(KC_T)
#    define KC_LL _GUI_T(KC_L)
#    define KC_II _GUI_T(KC_I)
#else
#    define KC_SS KC_S
#    define KC_DD KC_D
#    define KC_EE KC_E
...
#        define AS_TR_HOME  LT(_num_nav, KC_BSPC)
#    else
...
// ╰─────────────────────────────────────────────────────────╯
// #define ARSENIK_LAYOUT_ortho_5x12
#define ARSENIK_LAYOUT_perso
...
//  ──────────────────────────< My layout >──────────────────────────
#elif defined ARSENIK_LAYOUT_perso 
#define ARSENIK_LAYOUT(\
